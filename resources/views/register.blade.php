...
<head>
    ...
    <link rel="shortcut icon" href="{{ env('APP_URL') }}/web-gallery/favicon.ico" type="image/vnd.microsoft.icon" />
    ...
    <script src="{{ env('APP_URL') }}/web-gallery/js/skin.js" type="text/javascript"></script>
    <link rel="stylesheet" href="{{ env('APP_URL') }}/web-gallery/styles/quickregister.css" type="text/css" />
...
<div id="overlay"></div>
<div id="stepnumbers">
    <div class="step1focus">@lang('register_bean_and_gender')</div>
    <div class="step2">@lang('account_details')</div>
    <div class="step3">@lang('security_code')</div>
...
<div id="main-container">
    ...
    <div class="rounded" style="background-color: #cb2121;">
        <div id="error-title" class="error">
            @lang('register_error_bean')<br>
        </div>

    </div>
    <form id="quickregisterform2" method="post" action="{{ env('APP_URL') }}/register">

        <h2>@lang('register_bean_and_gender')</h2>

        <div id="date-selector">
            <h3>@lang('register_true_bean')</h3>
                ...
                <ul id="gender-choices">
                    <li id="ligender_M" onclick="changeGender('M');">
                        ...
                        <span class="gender-choice">
                            @lang('male')<br/><img alt="m"  src="{{ env('APP_URL') }}/web-gallery/images/male_sign.png" width="36" height="47">
                        </span>
                    </li>
                    <li id="ligender_F" onclick="changeGender('F');">
                        ...
                        <span class="bgbottom"></span>
                        <span class="gender-choice">
                            @lang('female')<br/><img alt="f"  src="{{ env('APP_URL') }}/web-gallery/images/female_sign.png" width="36" height="47">
                        </span>
                    </li>
                </ul>
            </div>
    ...
    <div id="select">
        <a id="back-link" href="{{ env('APP_URL') }}">@lang('Return')</a>
        <div class="button">
            <a id=""  href="#" onclick="document.forms['quickregisterform2'].submit();" class="area">@lang('Continue')</a>
