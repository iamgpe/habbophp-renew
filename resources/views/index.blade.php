...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="{{ str_replace('_', '-', app()->getLocale()) }}" lang="{{ str_replace('_', '-', app()->getLocale()) }}" xmlns:og="http://opengraphprotocol.org/schema/" xmlns:fb="http://www.facebook.com/2008/fbml">
<head>
...
<link rel="stylesheet" href="{{ env('APP_URL')}}/web-gallery/styles/frontpage.css" type="text/css" />
<script type="text/javascript" src="http://ajax.googleapis.com/ajax/libs/jquery/1.7.1/jquery.min.js"></script>
<script src="{{ env('APP_URL')}}/web-gallery/js/landing.js" type="text/javascript"></script>
<script src="{{ env('APP_URL')}}/web-gallery/js/password.js" type="text/javascript"></script>
...
<div id="landing-remember-me-notification" class="bottom-bubble" style="display:none;">
	...
	<div class="bottom-bubble-c">
                En cochant cette case tu resteras connecté à {{ env('APP_NAME')}} jusqu'à ce que tu choisisses de te déconnecter.
	</div>
	<div class="bottom-bubble-b"><div></div></div>
                ...
                <div id="login-form-password">
                    <label for="login-password" class="login-text">@lang('password')</label>
...
@if ($config->fb_appid != null && $config->fb_secret != null)
<a class="fb_button fb_button_large" onclick="assistedLogin(FB); return false;">
    <span class="fb_button_text">@lang('login_with_fb')</span>
</a>
@endif
                </div>
...
<div id="frontpage-image-container">
    ...
    <div id="join-now-button-container">
        ...
        <div id="join-now-button-wrapper">
            ...
            <div class="join-now-alternative">
                ...
                {{ env('APP_NAME')}} @lang('with_idx') Facebook
                </a>
            </div>
        </div>
    </div>
    ...
    <div id="people-inside">
        <b><span><span class="stats-fig">{{ $config->users_online }}</span> @lang('users_online_index')</span></b>
        <i></i>
    </div>
...
<div class="new_and_improved" id="footer">
	<p class="footer-links"><span style="color: rgb(255, 0, 0);"><strong><span style="font-family: Arial;">@lang('warning') </span><span style="color: rgb(255, 255, 255);"><span style="font-family: Arial;"> @lang('warning_message')</span></span></strong></span></span></p>
<div id="age-recommendation"></div>

    <div id="sulake-logo"><a href="http://www.sulake.com"></a></div>
	<p class="copyright">&copy; <a style="color:white" href="https://github.com/notaryzw3b/habbophp-renew">HabboPHP Renew</a> - {{ env('APP_ENV') }} version<br/>2009 - 2012 {{ env('APP_NAME') }}, Nous ne sommes pas lié ou autorisé par Sulake Corporation Oy. HABBO est une marque déposée de Sulake Corporation Oy dans l'Union Européenne, les Etats-Unis, le Japon, la république populaire de Chine et autres juridictions. Tous droits réservés.</p>
</div>
