...
<head>
	...
	<title>{{ env('APP_NAME') }} - Maintenance Break</title>
...
#loginerrorfieldwrapper{height:35px}#loginerrorfield{width:100%;height:100%;background-color:#c00;color:#fff}#loginerrorfield div{font-family:Arial;font-size:13pt;font-weight:bold;text-align:center;line-height:35px}#site-header #loginerrorfieldtest .hint{color:white;padding-left:10px}#habbo-logo{width:152px;min-height:60px;background:url(../images/habbologo_blackR.gif) no-repeat;float:left;margin-top:30px;margin-left:10px;display:inline}
</style>
...
@php if(isset($_GET['error']) == "invalidcreds") { @endphp
     <div id="loginerrorfieldwrapper">
                	...
                	<div>@lang('error_login_maintenance')</div>
            	</div>
        	</div>
	@php } @endphp
...
<p> 
Nous sommes d&eacute;sol&eacute; mais tu ne peux pas te connecter &agrave; {{ env('APP_NAME') }} pour l&#39;instant. Nous sommes en train de mettre &agrave; jour.
...
wola meme nous on sait pas frerot alors pose pas de questions
...
<script type="text/javascript">
    ...
    window.fbAsyncInit = function() {
        ...
        FB.init({appId: '{{ $config->fb_appid }}', status: true, cookie: true, xfbml: true, oauth: true});
    ...
    window.assistedLogin = function(FBobject, optresponse) {
        ...
        defaultAction = function(response) {
            ...
            if (response.authResponse) {
                fbConnectUrl = "{{ env('APP_URL') }}/register.php?page=5";
